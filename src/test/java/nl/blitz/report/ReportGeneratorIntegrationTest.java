 ...
 * ReportGeneratorService interface defines the public API contract that must be maintained.
 */
class ReportGeneratorIntegrationTest {
    ...
    void setUp() {
        ...
        List<List<String>> rows = Arrays.asList(Arrays.asList("Widget A", "10", "29.99"),
                Arrays.asList("Widget B", "5", "19.99"), Arrays.asList("Widget C", "15", "39.99"));

        sampleData = new ReportData("Sales Report", headers, rows, "Generated on 2024-01-15");
    }
    ...
    void testGeneratePDF() {
        ...
        String result = pdfGenerator.generate(request);
    ...
    void testGenerateCSV() {
        ...
        String result = csvGenerator.generate(request);
    ...
    void testGenerateHTML() {
        ...
        String result = htmlGenerator.generate(request);
    ...
    void testGenerateJSON() {
        ...
        String result = jsonGenerator.generate(request);
    ...
    void testGenerateXML() {
        ...
        // Act
        String result = xmlGenerator.generate(request);

        // Assert
        assertNotNull(result);
        assertTrue(result.contains("<title>Sales Report</title>"));
        assertTrue(result.contains("<headers>"));
        assertTrue(result.contains("<header>Product</header>"));
        assertTrue(result.contains("<rows>"));
        assertTrue(result.contains("<cell>Widget A</cell>"));
        assertTrue(result.contains("<metadata>Generated on 2024-01-15</metadata>"));
    }
